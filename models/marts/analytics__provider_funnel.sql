...
select
   ...
   -- r.hours_in_cold_provider_recruiting,
   -- r.hours_in_closed_lost_provider_recruiting,
    ...
    -- r.days_in_cold_provider_recruiting,
    -- r.days_in_closed_lost_provider_recruiting,
