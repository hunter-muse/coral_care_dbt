...
select
  ...
  provider_status,
  concat(provider.coral_provider_id, '-', to_char(current_timestamp, 'YYYY-MM-DD-HH24-MI-SS')) as provider_availability_id,
  ...
  cast(date_trunc('day', current_timestamp) as date) as snapshot_date
